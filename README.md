...
Ga naar 'REQUIREMENTS.txt' toe
Terwijl je in het bestand zit klik je op de terminal
Type dan in pip install Flask
Klik op 'main.py' en klik op 'run main'
...
DbBrowser: voor het volledig aanmaken en aanpassingen maken voor de webapplicatie's database
